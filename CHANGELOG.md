...
## [0.4.1-beta] - 2026-07-06

### Fixed
- Stale branding: Renamed remaining product references from "Vim Companion Desklet" to "modewerks".
- Stale lock resolution: Added safe PID lock cleanup on GTK/WebView window exit.
- Preflight security: Removed writing of temporary file `/tmp/modewerks_preflight.txt` in `INSTALL.sh`.

### Added
- Singleton instance policy documentation.
- Manual desklet verification checklist template.
